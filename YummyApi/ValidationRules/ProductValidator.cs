...
namespace YummyApi.ValidationRules
{
    public class ProductValidator:AbstractValidator<Product>
    {
        public ProductValidator()
        {
            ...
            RuleFor(x => x.ProductDescription).NotEmpty().WithMessage("The product name cannot be empty.")
                .MinimumLength(10).WithMessage("Product name cannot be shorter than 10 characters.")
                .MaximumLength(500).WithMessage("Product name can be a maximum of 500 characters.");
        }
    }
}
